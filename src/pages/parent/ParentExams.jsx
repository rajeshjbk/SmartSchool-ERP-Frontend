...
export function ParentExams() {
  ...
  const getExams = async () => {
    try {
      const response = await api.get(`/schoolerp/exams/parent/${parentId}`);
  ...
  return (
    <div className="container-fluid p-4 bg-light min-vh-100">
      ...
      <div className="card shadow-lg border-0 rounded-4 bg-dark text-white p-4 mb-4">
        <h2 className="fw-bold">Child Exams</h2>

        <p className="mb-0">View your child's exam schedule and status</p>
      </div>
