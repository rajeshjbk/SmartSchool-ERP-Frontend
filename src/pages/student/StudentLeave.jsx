...
export function StudentLeave() {
  ...
  const handleChange = (e) => {
    ...
    if (updatedForm.fromDate && updatedForm.toDate) {
      ...
      updatedForm.totalDays = diff > 0 ? diff : 0;
    }
  ...
  const handleEdit = (leave) => {
    ...
    setFormData({
      ...
      approvedById: leave.approvedBy?.userId || "",
  ...
  return (
    <div className="container-fluid p-4 bg-light min-vh-100">
      ...
      <div className="card shadow-lg border-0 rounded-4 bg-success text-white p-4 mb-4">
        ...
        <p className="mb-0">Apply and track your leave requests</p>
      </div>
      ...
      <div className="card shadow-lg border-0 rounded-4">
        <div className="card-body">
          <div className="d-flex justify-content-between mb-3">
            <h4 className="text-success">My Leave Records</h4>
